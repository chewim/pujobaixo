...
- Contenedor "hero" en degradado de marca: `radial-gradient(120% 90% at 0% 0%, rgba(255,255,255,0.22), transparent 55%)` sobre `linear-gradient(135deg, #6D5CFF 0%, #5B4CFB 45%, #4633E8 100%)`, radio 16, sin borde, sombra de color `0 12px 32px -16px rgba(91,76,251,0.55)`. El radial es el "brillo" superior-izquierdo. Contenido en blanco: título `#fff`, subtítulo `rgba(255,255,255,0.78)`, icono en círculo `rgba(255,255,255,0.16)`, "Canviar" blanco subrayado, focus en blanco. Interruptor invertido: pista apagada `rgba(255,255,255,0.28)` con botón blanco; activa pista blanca con botón `#5B4CFB`. Los segmentados interiores se quedan blancos: son la superficie de control dentro del objeto.
